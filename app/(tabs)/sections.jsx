...
import { getSections, createSection, getGradeLevels, getAcademicYears, getTeachers, updateSection, deleteSection } from "../../lib/supabase"
    ...
    return (
      <TouchableOpacity style={[styles.sectionCard, { backgroundColor: isDarkMode ? "#333" : "#fff" }]}>
        <View style={styles.sectionInfo}>
          ...
          <Text style={[styles.sectionDetails, { color: isDarkMode ? "#ccc" : "#666" }]}>
            Advisor: {item.teachers?.profiles ? 
